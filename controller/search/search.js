...
var SearchServiceProxy = require('../../proxy/gen-nodejs/SearchServiceProxy.js');
...
module.exports = {
    ...
    record: function* (){
        ...
        // 进行PRC远程调用
        var queryService = thrift.createClient(SearchServiceProxy, connection);

        // 获取数据
        var recordData = yield queryService.searcher(qs, pageNum);
